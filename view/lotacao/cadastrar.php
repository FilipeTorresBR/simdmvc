<div id="cadastrar-lotacao-modal" class="w3-modal" style="z-index: 10;">
  <div class="w3-modal-content" style="width: 600px; background: #dedede;" >
    <header class="w3-container green" style="color: white; background-color: #00c952; cursor: default;">
      ...
      <h2>Adicionar um Lotacao</h2>
    </header>
    <div class="w3-contant" style="margin-left:70px;">
      <div class="box formcad">
        <form action="?c=<?php echo base64_encode("Lotacao"); ?>&a=<?php echo base64_encode("cadastrar") ?>" method="post">
        <label for="nome">Nome do Lotacao:</label><br>

<div id="add-institucional-modal" class="w3-modal" style="z-index: 10;">
  <div class="w3-modal-content" style="width: 600px; background: #dedede;" >
    <header class="w3-container green" style="color: white;">
      ...
      <h2>Adicionar um Lotação</h2>
  </header>
  <div class="w3-contant" style="margin-left:70px;">
    <form class="box" action="cadastro/add-lotacao.php" method="post">
    <label for="nome">Nome do Lotação:</label><br>
...
<div class="list-options-position">
  <form>
    <a id="<?php echo $display; ?> modal-trigger" add-institucional="Tem certeza?" href="#" class="btn-pattern green">Cadastrar um Lotação</a>

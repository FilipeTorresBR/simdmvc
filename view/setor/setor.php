<div id="add-institucional-modal" class="w3-modal" style="z-index: 10;">
  ...
  <div class="w3-contant" style="margin-left:70px;">
    <form class="box" action="cadastro/add-setor.php" method="post">
...
<div class="list-options-position">
  <form>
    <a id="<?php echo $display; ?> modal-trigger" add-institucional="Tem certeza?" href="#" class="btn-pattern green">Cadastrar um Setor</a>

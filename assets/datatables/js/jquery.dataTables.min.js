...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Anterior",sPrevious:"Proximo"},sEmptyTable:"No data available in table",sInfo:"Exibindo de _START_ a _END_ de _TOTAL_ dados",sInfoEmpty:"Nenhum dado cadastrado",sInfoFiltered:"(filtrado de um total de _MAX_ dados)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Exibir _MENU_ dados",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Filtrar por:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Nenhum resultado para esta pesquisa"},oSearch:k.extend({},u.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};G(u.defaults);u.defaults.column={aDataSort:null,
